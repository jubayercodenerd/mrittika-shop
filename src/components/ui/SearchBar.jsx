...
const SearchBar = ({ placeHolder, inputClassName, outerDivClassName }) => {
    return (
        <div className={`flex h-10 rounded-md border- border-[#4e132f] overflow-hidden ${outerDivClassName}`} >
            ...
            />
            <button className="flex justify-center items-center h-full bg-orange-100 aspect-square border-l-2 border-[#4e132f] text-white">
